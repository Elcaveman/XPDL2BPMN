...
/**
 * This is the item provider adapter for a {@link xPDL.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Participant_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Participant_id_feature",
								"_UI_Participant_type"),
						XPDLPackage.Literals.PARTICIPANT__ID, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Participant_name_feature",
								"_UI_Participant_type"),
						XPDLPackage.Literals.PARTICIPANT__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XPDLPackage.Literals.PARTICIPANT__POOLS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case XPDLPackage.PARTICIPANT__ID:
		case XPDLPackage.PARTICIPANT__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case XPDLPackage.PARTICIPANT__POOLS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(XPDLPackage.Literals.PARTICIPANT__POOLS, XPDLFactory.eINSTANCE.createPool()));
	}
