 ...
 *   <li>{@link bpmn.impl.ActivityImpl#getIncomingMessages <em>Incoming Messages</em>}</li>
 *   <li>{@link bpmn.impl.ActivityImpl#getOutgoingMessages <em>Outgoing Messages</em>}</li>
 *   <li>{@link bpmn.impl.ActivityImpl#getOrderedMessages <em>Ordered Messages</em>}</li>
 *   <li>{@link bpmn.impl.ActivityImpl#getActivityType <em>Activity Type</em>}</li>
 *   <li>{@link bpmn.impl.ActivityImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link bpmn.impl.ActivityImpl#getEventHandlerFor <em>Event Handler For</em>}</li>
 *   <li>{@link bpmn.impl.ActivityImpl#getLane <em>Lane</em>}</li>
 *   <li>{@link bpmn.impl.ActivityImpl#isLooping <em>Looping</em>}</li>
...
public class ActivityImpl extends VertexImpl implements Activity {
	 ...
	 * @ordered
	 */
	protected EList incomingMessages = null;
	 ...
	 * @ordered
	 */
	protected EList outgoingMessages = null;
	 ...
	 * @ordered
	 */
	protected EList orderedMessages = null;
	 ...
	 * @ordered
	 */
	protected boolean activityTypeESet = false;
	 ...
	 * @ordered
	 */
	protected boolean loopingESet = false;
