 ...
 * <ul>
 *   <li>{@link bpmn.impl.EdgeImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link bpmn.impl.EdgeImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link bpmn.impl.EdgeImpl#getGraph <em>Graph</em>}</li>
 *   <li>{@link bpmn.impl.EdgeImpl#getID <em>ID</em>}</li>
 *   <li>{@link bpmn.impl.EdgeImpl#getName <em>Name</em>}</li>
 *   <li>{@link bpmn.impl.EdgeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link bpmn.impl.EdgeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
