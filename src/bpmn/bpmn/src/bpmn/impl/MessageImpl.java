 ...
 * <ul>
 *   <li>{@link bpmn.impl.MessageImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link bpmn.impl.MessageImpl#getBpmnDiagram <em>Bpmn Diagram</em>}</li>
 *   <li>{@link bpmn.impl.MessageImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link bpmn.impl.MessageImpl#getID <em>ID</em>}</li>
 *   <li>{@link bpmn.impl.MessageImpl#getName <em>Name</em>}</li>
 *   <li>{@link bpmn.impl.MessageImpl#getSource <em>Source</em>}</li>
 *   <li>{@link bpmn.impl.MessageImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
