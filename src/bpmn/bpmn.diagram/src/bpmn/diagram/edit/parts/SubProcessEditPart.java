...
import bpmn.diagram.edit.policies.SubProcessCanonicalEditPolicy;
import bpmn.diagram.edit.policies.SubProcessGraphicalNodeEditPolicy;
import bpmn.diagram.edit.policies.SubProcessItemSemanticEditPolicy;
...
public class SubProcessEditPart extends ShapeNodeEditPart {
	...
	public class SubProcessFigure extends
		...
		private void createContents() {
			...
			bpmn.figures.SubProcessBodyFigure fig_1 = new bpmn.figures.SubProcessBodyFigure();
			...
			bpmn.figures.SubProcessBorderFigure fig_2 = new bpmn.figures.SubProcessBorderFigure();
		 ...
		 * @generated
		 */
		private bpmn.figures.SubProcessBodyFigure fSubProcessBodyFigure;

		/**
		 * @generated
		 */
		public bpmn.figures.SubProcessBodyFigure getFigureSubProcessBodyFigure() {
		...
		private void setFigureSubProcessBodyFigure(
				bpmn.figures.SubProcessBodyFigure fig) {
		 ...
		 * @generated
		 */
		private bpmn.figures.SubProcessBorderFigure fSubProcessBorderFigure;

		/**
		 * @generated
		 */
		public bpmn.figures.SubProcessBorderFigure getFigureSubProcessBorderFigure() {
		...
		private void setFigureSubProcessBorderFigure(
				bpmn.figures.SubProcessBorderFigure fig) {
