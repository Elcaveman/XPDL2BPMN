...
import bpmn.diagram.edit.policies.PoolCanonicalEditPolicy;
import bpmn.diagram.edit.policies.PoolGraphicalNodeEditPolicy;
import bpmn.diagram.edit.policies.PoolItemSemanticEditPolicy;
import bpmn.diagram.part.BpmnVisualIDRegistry;
import bpmn.policies.ResizableShapeEditPolicyEx;
...
public class PoolEditPart extends ShapeNodeEditPart {
	...
	public class PoolFigure extends org.eclipse.draw2d.RectangleFigure {
		...
		private void createContents() {
			bpmn.figures.VerticalLabel fig_0 = new bpmn.figures.VerticalLabel();
		 ...
		 * @generated
		 */
		private bpmn.figures.VerticalLabel fPoolNameFigure;

		/**
		 * @generated
		 */
		public bpmn.figures.VerticalLabel getFigurePoolNameFigure() {
		...
		private void setFigurePoolNameFigure(
				bpmn.figures.VerticalLabel fig) {
			fPoolNameFigure = fig;
		}
