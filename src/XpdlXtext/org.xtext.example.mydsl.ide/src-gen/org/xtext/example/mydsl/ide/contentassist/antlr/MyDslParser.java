...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParticipantAccess().getGroup_3(), "rule__Participant__Group_3__0");
			builder.put(grammarAccess.getParticipantAccess().getGroup_7(), "rule__Participant__Group_7__0");
			...
			builder.put(grammarAccess.getActivitySetAccess().getGroup_4(), "rule__ActivitySet__Group_4__0");
			builder.put(grammarAccess.getActivitySetAccess().getGroup_8(), "rule__ActivitySet__Group_8__0");
			...
			builder.put(grammarAccess.getXpdlRootAccess().getParticipantsAssignment_5_2(), "rule__XpdlRoot__ParticipantsAssignment_5_2");
			builder.put(grammarAccess.getXpdlRootAccess().getParticipantsAssignment_5_3_1(), "rule__XpdlRoot__ParticipantsAssignment_5_3_1");
			...
			builder.put(grammarAccess.getParticipantAccess().getIdAssignment_1(), "rule__Participant__IdAssignment_1");
			builder.put(grammarAccess.getParticipantAccess().getNameAssignment_3_1(), "rule__Participant__NameAssignment_3_1");
			builder.put(grammarAccess.getParticipantAccess().getPoolsAssignment_6(), "rule__Participant__PoolsAssignment_6");
			builder.put(grammarAccess.getParticipantAccess().getPoolsAssignment_7_1(), "rule__Participant__PoolsAssignment_7_1");
			builder.put(grammarAccess.getProcessAccess().getIdAssignment_2(), "rule__Process__IdAssignment_2");
			builder.put(grammarAccess.getProcessAccess().getNameAssignment_4_1(), "rule__Process__NameAssignment_4_1");
			builder.put(grammarAccess.getProcessAccess().getWorkflowParticipantsAssignment_5_2(), "rule__Process__WorkflowParticipantsAssignment_5_2");
			builder.put(grammarAccess.getProcessAccess().getWorkflowParticipantsAssignment_5_3_1(), "rule__Process__WorkflowParticipantsAssignment_5_3_1");
			...
			builder.put(grammarAccess.getActivitySetAccess().getParticipantAssignment_4_1(), "rule__ActivitySet__ParticipantAssignment_4_1");
			builder.put(grammarAccess.getActivitySetAccess().getActivitiesAssignment_7(), "rule__ActivitySet__ActivitiesAssignment_7");
			builder.put(grammarAccess.getActivitySetAccess().getActivitiesAssignment_8_1(), "rule__ActivitySet__ActivitiesAssignment_8_1");
